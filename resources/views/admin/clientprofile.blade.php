                    ...
                    <div class="col">
                        <div id="" class="m-2 card h-100" data-name="reasons">
                            ...
                            <div class="card-footer">
                                <h5>
                                    <form
                                        action="{{ route('admin.edit.client_reason', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}"
                                    ...
                                    {{-- <a
                                        href="{{ route('admin.edit.client_reason', ['locale' => app()->getLocale()]) }}">edit
                                        information</a></h5> --}}
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div id="" class="m-2 card h-100 " data-name="debt_strcuture">
                            ...
                            <div class="card-footer">
                                <h5>
                                    <form
                                        action="{{ route('admin.edit.client_debtStructure', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}"
                                        method="GET" class="email-form">
                                        @csrf
                                    ...
                                    {{-- <a
                                        href="{{ route('admin.edit.client_debtStructure', ['locale' => app()->getLocale()]) }}">edit
                                        information</a> --}}
                                </h5>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div id="" class="m-2 card h-100 " data-name="payment">
                            ...
                            <div class="card-footer">
                                <h5>
                                    <form
                                    action="{{ route('admin.edit.client_ratio', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}"
                                    method="GET" class="email-form">
                                    @csrf
                                    <input type="hidden" name="id"
                                        value="{{ $clientProfile->client_id }}">
                ...
                <div class="row mt-3">
                    <div class="col">
                        <div id="" class="m-2 card h-100" data-name="foreclosure">
                            ...
                            <div class="card-body">
                                Not enough data </div>
                            <div class="card-footer">
                                <h5><a href="{{ route('admin.edit.foreclosure', ['locale' => app()->getLocale()]) }}">edit
                                        information</a></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div id="" class="m-2 card h-100 package basic" data-name="garnishment">
                            ...
                            <div class="card-footer">
                                <h5><a
                                        href="{{ route('admin.edit.client_garnishment', ['locale' => app()->getLocale()]) }}">edit
                                        information</a></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div id="" class="m-2 card h-100 " data-name="payment">
                            ...
                            <div class="card-footer">
                                <h5><a
                                        href="{{ route('admin.edit.client_lawsuit', ['locale' => app()->getLocale()]) }}">edit
                                        information</a></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div id="" class="m-2 card h-100" data-name="budget">
                            ...
                            <div class="card-footer">
                                <h5>
                                    <form
                                    action="{{ route('admin.edit.client_budget', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}"
                                    method="GET" class="email-form">
                                    @csrf
                                    <input type="hidden" name="id"
                                        value="{{ $clientProfile->client_id }}">
                                    ...
                                    {{-- <a
                                        href="{{ route('admin.edit.client_budget', ['locale' => app()->getLocale()]) }}">edit
                                        information</a> --}}
                                    </h5>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div id="" class="m-2 card h-100 package basic" data-name="account">
                            ...
                            <div class="card-footer">
                                <h5>
                                    <form
                                        action="{{ route('admin.edit.client_accountInfo', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}"
                                        method="GET" class="email-form">
                                        @csrf
                                        <input type="hidden" name="id"
                                            value="{{ $clientProfile->client_id }}">
                                    ...
                                    {{-- <a
                                        href="{{ route('admin.edit.client_accountInfo', ['locale' => app()->getLocale()]) }}">edit
                                        information</a></h5> --}}
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div id="" class="m-2 card h-100 package basic" data-name="client">
                            ...
                            <div class="card-footer">
                                <h5>
                                    <form
                                        action="{{ route('admin.edit.client_personalInfo', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}"
                                        method="GET" class="email-form">
                                        @csrf
                                        <input type="hidden" name="id"
                                            value="{{ $clientProfile->client_id }}">
                                    ...
                                    {{-- <a
                                        href="{{ route('admin.edit.client_personalInfo', ['locale' => app()->getLocale()]) }}">edit
                                        information</a></h5> --}}
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div id="" class="m-2 card h-100 package basic" data-name="basic">
                            ...
                            <div class="card-footer">
                                <h5>
                                    <form
                                        action="{{ route('admin.edit.client_attorney', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}"
                                        method="GET" class="email-form">
                                        @csrf
                                        <input type="hidden" name="id"
                                            value="{{ $clientProfile->client_id }}">
                                    ...
                                    {{-- <a href="{{ route('admin.edit.client_attorney', ['locale' => app()->getLocale()]) }}">edit information</a> --}}
                                </h5>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="" class="m-2 card h-100" data-name="Course">
                            ...
                            <div class="card-footer">
                                <h5>
                                    ...
                                    <form
                                    action="{{ route('admin.edit.course_info', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}"
                                    method="GET" class="email-form">
                                    @csrf
                                    <input type="hidden" name="id"
                                        value="{{ $clientProfile->client_id }}">
                                    ...
                                    {{-- <a
                                        href="{{ route('admin.edit.course_info', ['locale' => app()->getLocale()]) }}">edit
                                        information</a> --}}
                                </h5>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div id="" class="m-2 card h-100 package basic" data-name="optional_service">
                            ...
                            <div class="card-footer">
                                <h5>
                                    <form
                                        action="{{ route('admin.edit.client_optionalServices', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}"
                                        method="GET" class="email-form">
                                        @csrf
                                        <input type="hidden" name="id"
                                            value="{{ $clientProfile->client_id }}">
                    ...
                    <div class="col">
                        <div id="" class="m-2 card h-100 " data-name="payment">
                            ...
                            <div class="card-footer">
                                <h5>
                                    <form
                                        action="{{ route('admin.edit.client_payment', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}"
                                        method="GET" class="email-form">
                                        @csrf
                                        <input type="hidden" name="id"
                                            value="{{ $clientProfile->client_id }}">
