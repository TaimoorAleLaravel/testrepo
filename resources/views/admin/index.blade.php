    ...
    <main class="bg-white min-vh-100">
        ...
        <div class="container">
            ...
            <article class="course reason">
                ...
                <header class="mt-3">
                    <span class="h2 text-success font-weight-normal">Administrator</span>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-info">
                    ...
                    <div class="collapse navbar-collapse" id="navbarColor02">
                        <form id="filterForm" action="{{ route('admin.applyfilter', ['locale' => app()->getLocale()]) }}" method="GET" enctype="multipart/form-data">
                            @csrf
                            <div class="container">
                    ...
                    <form id="filterForm" action="{{ route('admin.applyfilter', ['locale' => app()->getLocale()]) }}" method="GET" enctype="multipart/form-data">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-12 col-md-2 mb-3">
                                <button type="submit" id="filter_apply" class="btn btn-primary btn-block">
                                    Apply
                                </button>
                            </div>
                        </div>
                ...
                <a href="{{ route('admin.viewcounsler', ['locale' => app()->getlocale()]) }}"><button
                        class="btn btn-outline-success">View Counselors</button></a>

                <a href="{{ route('admin.add-Counselor', ['locale' => app()->getlocale()]) }}"><button
                        class="btn btn-outline-success">Add Counselor</button></a>
                <br><br>
                <span class="h3 ">All Clients</span>
                            ...
                            @foreach ($clientProfiles as $clientProfile)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.clientprofile', ['id' => $clientProfile->client_id, 'locale' => app()->getLocale()]) }}" method="GET" class="email-form">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $clientProfile->client_id }}">
                                            <span class="__cf_email__" style="color: blue" data-cfemail="1e6a7b6d6a5e79737f7772307d7173">{{ $clientProfile->client->client_email }}</span>
                                        </form>
                                    </td>
                                    <td>{{ $clientProfile->client->attorny }}</td>
                                    <td>{{ $clientProfile->client->status }}</td>
                                    <td>
                                        ...
                                        <div style="display:flex; gap:5px">
                                            <div>
                                                @if ($clientProfile->pkg == 1)
                                                    <img alt="Basic Package" width="30" height="30" class="d-block" src="{{ asset('assets/basic1.png') }}">
                                                @elseif ($clientProfile->pkg == 2)
                                                    <img alt="Regular Package" width="30" height="30" class="d-block" src="{{ asset('assets/regular.png') }}">
                                                @elseif ($clientProfile->pkg == 3)
                                                    <img alt="Premium Package" width="30" height="30" class="d-block" src="{{ asset('assets/premium.png') }}">
                                                @else
                                                    <img alt="No Package" width="30" height="30" class="d-block" src="{{ asset('assets/credit_card.png') }}">
                                                @endif
                                            </div>
                                    ...
                                    <td>
                                        <center>
                                            <div style="width: 30px; height: 30px; border-radius: 50%; background-image: conic-gradient(lightgray 0deg,green 0 235deg);">
                                            </div>
                                        </center>
                                    </td>
                                    <td>
                                        <div>
                                            <a href="../counselor/counselor_chat_with_client?client=181">
                                                <img alt="Image: Chat" width="30" height="30" class="d-block" src="{{ asset('assets/chat.png') }}">
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="d-flex col justify-content-center">
                    {{ $clientProfiles->links('pagination::bootstrap-5') }}
                    ...
                    fetch(form.action, {
                        ...
                        .then(data => {
                            ...
                            data.forEach((profile, index) => {
                                ...
                                row.innerHTML = `
                                <td>${index + 1}</td>
                                <td>${profile.client.fname} ${profile.client.lname}<span style="color: blue">${profile.client.client_email}</span></td>
