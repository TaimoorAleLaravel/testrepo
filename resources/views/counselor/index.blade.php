    ...
    <main class="bg-white min-vh-100">
        ...
        <div class="container">
            ...
            <article class="course reason">
                ...
                <br>
                {{-- <a href="{{ route('counsler.viewcounsler', ['locale' => app()->getlocale()]) }}"><button
                        class="btn btn-outline-success">View Counselors</button></a>

                <a href="{{ route('counsler.add-Counselor', ['locale' => app()->getlocale()]) }}"><button
